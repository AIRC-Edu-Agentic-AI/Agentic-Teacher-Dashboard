...
app.get('/api/index', authenticateToken, async (req, res) => {
...
app.get('/api/course/:module/:presentation', authenticateToken, async (req, res) => {
...
app.get('/api/student/:module/:presentation/:student_id', authenticateToken, async (req, res) => {
